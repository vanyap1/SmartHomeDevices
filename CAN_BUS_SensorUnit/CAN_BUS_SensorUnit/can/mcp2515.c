...
gpio canEn = {(uint8_t *)&PORTB , PORTB2};
gpio canReset = {(uint8_t *)&PORTB , PORTB1};
...
bool MCP2515_Initialize(void)
{
	...
	gpio_set_pin_level(&canReset, false);
	gpio_set_pin_direction(&canReset , PORT_DIR_OUT);
	_delay_ms(10);
	gpio_set_pin_level(&canReset, true);
